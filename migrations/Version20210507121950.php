 ...
 */
final class Version20210507121950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE salarie (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, date_naissance DATE NOT NULL, adresse VARCHAR(50) DEFAULT NULL, cp VARCHAR(10) DEFAULT NULL, ville VARCHAR(30) DEFAULT NULL, date_embauche DATE NOT NULL, INDEX IDX_828E3A1AA4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
